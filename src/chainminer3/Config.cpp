...
void readConfig() {
    ...
    for (auto& el : config_j["blocks"].items()) {
        ...
        if (el.value().contains("detect_mode")) {
            if (const string detectMode = el.value()["detect_mode"]; detectMode == "cube" || detectMode == "abut") {
    ...
    // player_setting
    playersetting::playerSetting.load();
    // op_list
    op_list.clear();
    ...
    if (config_j["multiply_damage"].size() == 2 && config_j["multiply_damage"][0].is_number()
        && config_j["multiply_damage"][1].is_number()) {
...
#define DEFAULT_PARAMS                                                                                                 \
    {"limit", 256}, { "cost", 0 }
#define DEFAULT_PARAMS_LOG                                                                                             \
    {"limit", 256}, {"cost", 0}, {"SilkTouch", 2}, {                                                                   \
        "tools", {                                                                                                     \
...
json getDefaultConfig() {
    ...
    json j = {
        ...
        {"blocks",
         {
             // {"minecraft:log",
             // {DEFAULT_PARAMS_LOG,{"texture","textures/blocks/log_oak_top"},{"name","橡木/云杉木/白桦木/丛林木"}}},//木头（橡木、云杉木、白桦木、丛林木）
             // {"minecraft:log2",
             // {DEFAULT_PARAMS_LOG,{"texture","textures/blocks/log_acacia_top"},{"name","金合欢木/深色橡木"}}},//木头（金合欢木、深色橡木）
             {"minecraft:oak_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/log_oak_top"}, {"name", "橡木原木"}}}, // 橡木原木
             {"minecraft:spruce_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/log_spruce_top"}, {"name", "云杉木原木"}}
             }, // 云杉木原木
             {"minecraft:birch_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/log_birch_top"}, {"name", "白桦木原木"}}}, // 白桦木原木
             {"minecraft:jungle_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/log_jungle_top"}, {"name", "云杉木原木"}}
             }, // 云杉木原木
             {"minecraft:acacia_log",
              {DEFAULT_PARAMS_LOG,
               {"texture", "textures/blocks/log_acacia_top"},
               {"name", "金合欢木原木"},
               {"detect_mode", "cube"}}}, // 金合欢木原木
             {"minecraft:dark_oak_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/log_big_oak_top"}, {"name", "深色橡木原木"}}
             }, // 深色橡木原木
             {"minecraft:mangrove_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/mangrove_log_top"}, {"name", "红树原木"}}}, // 红树原木
             {"minecraft:cherry_log",
              {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/cherry_log_top"}, {"name", "樱花原木"}}}, // 红树原木
             {"minecraft:crimson_stem",
              {DEFAULT_PARAMS_LOG,
               {"texture", "textures/blocks/huge_fungus/stripped_crimson_stem_top"},
               {"name", "绯红菌柄"}}}, // 绯红菌柄
             {"minecraft:warped_stem",
              {DEFAULT_PARAMS_LOG,
               {"texture", "textures/blocks/huge_fungus/stripped_warped_stem_top"},
               {"name", "诡异菌柄"}}},                                                // 诡异菌柄
             {"minecraft:quartz_ore", {DEFAULT_PARAMS, {"name", "下界石英矿石"}}},    // 石英矿
             {"minecraft:nether_gold_ore", {DEFAULT_PARAMS, {"name", "下界金矿石"}}}, // 下界金矿
             {"minecraft:ancient_debris",
              {DEFAULT_PARAMS, {"texture", "textures/blocks/ancient_debris_top"}, {"name", "远古残骸"}}}, // 远古残骸
             {"minecraft:iron_ore", {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_iron_ore"}}, {"name", "铁矿石"}}
             }, // 铁矿
             {"minecraft:gold_ore", {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_gold_ore"}}, {"name", "金矿石"}}
             }, // 金矿
             {"minecraft:diamond_ore",
              {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_diamond_ore"}}, {"name", "钻石矿石"}}}, // 钻石矿
             {"minecraft:lapis_ore",
              {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_lapis_ore"}}, {"name", "青金石矿石"}}}, // 青金石矿
             {"minecraft:coal_ore", {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_coal_ore"}}, {"name", "煤矿石"}}
             }, // 煤矿
             {"minecraft:copper_ore",
              {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_copper_ore"}}, {"name", "铜矿石"}}}, // 铜矿
             {"minecraft:emerald_ore",
              {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_emerald_ore"}}, {"name", "绿宝石矿石"}}}, // 绿宝石矿
             {"minecraft:lit_redstone_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/redstone_ore"},
               {"similar",
                {"minecraft:lit_deepslate_redstone_ore", "minecraft:redstone_ore", "minecraft:deepslate_redstone_ore"}},
               {"name", "红石矿石"}}}, // 红石矿
             {"minecraft:lit_deepslate_redstone_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_redstone_ore"},
               {"similar", {"minecraft:lit_redstone_ore", "minecraft:redstone_ore", "minecraft:deepslate_redstone_ore"}
               },
               {"name", "深层红石矿石"}}}, // 深层红石矿
             {"minecraft:deepslate_copper_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_copper_ore"},
               {"similar", {"minecraft:copper_ore"}},
               {"name", "深层铜矿石"}}}, // 深层铜矿
             {"minecraft:deepslate_iron_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_iron_ore"},
               {"similar", {"minecraft:iron_ore"}},
               {"name", "深层铁矿石"}}}, // 深层铁矿
             {"minecraft:deepslate_gold_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_gold_ore"},
               {"similar", {"minecraft:gold_ore"}},
               {"name", "深层金矿石"}}}, // 深层金矿
             {"minecraft:deepslate_diamond_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_diamond_ore"},
               {"similar", {"minecraft:diamond_ore"}},
               {"name", "深层钻石矿石"}}}, // 深层钻石矿
             {"minecraft:deepslate_lapis_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_lapis_ore"},
               {"similar", {"minecraft:lapis_ore"}},
               {"name", "深层青金石矿石"}}}, // 深层青金石矿
             {"minecraft:deepslate_emerald_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_emerald_ore"},
               {"similar", {"minecraft:emerald_ore"}},
               {"name", "深层绿宝石矿石"}}}, // 深层绿宝石矿
             {"minecraft:deepslate_coal_ore",
              {DEFAULT_PARAMS,
               {"texture", "textures/blocks/deepslate/deepslate_coal_ore"},
