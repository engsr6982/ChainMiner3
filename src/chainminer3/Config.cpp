            ...
            {"blocks",
             {
                 ...
                 {"minecraft:birch_log",
                  {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/log_birch_top"}, {"name", "白桦木原木"}}
                 }, // 白桦木原木
                 ...
                 {"minecraft:mangrove_log",
                  {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/mangrove_log_top"}, {"name", "红树原木"}}
                 }, // 红树原木
                 {"minecraft:cherry_log",
                  {DEFAULT_PARAMS_LOG, {"texture", "textures/blocks/cherry_log_top"}, {"name", "樱花原木"}}
                 }, // 红树原木
                 ...
                 {"minecraft:ancient_debris",
                  {DEFAULT_PARAMS, {"texture", "textures/blocks/ancient_debris_top"}, {"name", "远古残骸"}}
                 }, // 远古残骸
                 {"minecraft:iron_ore",
                  {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_iron_ore"}}, {"name", "铁矿石"}}}, // 铁矿
                 {"minecraft:gold_ore",
                  {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_gold_ore"}}, {"name", "金矿石"}}}, // 金矿
                 ...
                 {"minecraft:coal_ore",
                  {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_coal_ore"}}, {"name", "煤矿石"}}}, // 煤矿
                 {"minecraft:copper_ore",
                  {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_copper_ore"}}, {"name", "铜矿石"}}}, // 铜矿
                 {"minecraft:emerald_ore",
                  {DEFAULT_PARAMS, {"similar", {"minecraft:deepslate_emerald_ore"}}, {"name", "绿宝石矿石"}}
                 }, // 绿宝石矿
                 ...
                 {"minecraft:lit_deepslate_redstone_ore",
                  {DEFAULT_PARAMS,
                   ...
                   {"similar",
                    {"minecraft:lit_redstone_ore", "minecraft:redstone_ore", "minecraft:deepslate_redstone_ore"}},
                   {"name", "深层红石矿石"}}}, // 深层红石矿
